...
{
    public partial class EodrLngMembraneBHDMeasurementForm : Form
    {
        ...
        public EodrLngMembraneBHDMeasurementForm(EodrLngMembraneMenuParameter eodrLngMembraneMenuParameter)
        {
            InitializeComponent();
            _eodrLngMembraneMenuParameter = eodrLngMembraneMenuParameter;
        }

        private void EodrLngMembraneBHDMeasurementForm_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void EodrLngMembraneBHDMeasurementForm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void EodrLngMembraneBHDMeasurementForm_Load(object sender, EventArgs e)
        {
            this.labelReportNo.Text = _eodrLngMembraneMenuParameter.ReportNo;
            this.labelTankNo.Text = _eodrLngMembraneMenuParameter.TankNo;
            this.labelPlaneCode.Text = _eodrLngMembraneMenuParameter.PlaneCode;
